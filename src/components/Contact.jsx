  ...
  return (
    <div className="bg-light dark:bg-dark">
      <div className="container mx-auto p-6 font-poppins min-h-screen">
        <div className="flex flex-col lg:flex-row lg:p-10 justify-center items-center w-full sm:h-screen lg:h-fit lg:rounded-lg lg:bg-white dark:lg:bg-button2 lg:mb-5">
          <Form />
