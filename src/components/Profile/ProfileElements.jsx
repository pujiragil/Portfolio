...
export const ProfileButton = () => {
  return (
    <button className="lg:w-[400px] md:w-9/12 flex gap-x-4 justify-center items-center bg-button text-lg font-medium text-white py-4 px-6 rounded border-none outline-none">
