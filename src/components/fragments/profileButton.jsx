...
export const ProfileButton = () => {
  return (
    <div className="flex w-full mb-10 text-sm md:text-lg font-medium">
...
export const ProfileMenu = () => {
  return (
    <div className="flex w-full p-2 bg-button2 rounded-lg mb-10 text-sm md:text-lg font-medium">
