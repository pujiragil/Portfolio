...
export const ProfileButton = () => {
  return (
    <div className="flex w-full lg:w-1/2 xl:w-2/5 2xl:w-2/5 mb-10 text-sm md:text-lg font-medium">
      <a href="https://drive.google.com/file/d/1SAqQbHfGRoLpSksRZQ3hYarBeEhZ2Uxc/view?usp=sharing" download="portfolio" className="bg-button dark:bg-dbutton hover:text-button2 dark:hover:bg-buttonhov duration-300 ease-in-out text-button py-3 rounded-lg mr-4 w-full flex justify-center items-center">Download CV <HiDownload className="ml-2"/></a>
